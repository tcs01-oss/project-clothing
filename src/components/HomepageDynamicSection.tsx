...
export default function HomepageDynamicSection({
  ...
  return (
    <section className="relative overflow-hidden py-8 sm:py-16 px-1.5 sm:px-4 md:px-6 w-full max-w-none bg-[#F5F0E8]/95 border-b border-terrain/10" id={`homepage-section-${section.id}`}>
