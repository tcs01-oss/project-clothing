...
export default function AIConsole({ isOpen, onClose, cartItems, activeProductId, onSelectSuggestion }: AIConsoleProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      sender: "bot",
      text: "🌿 **Greetings, Wanderer!** I am your tirupati merchandise Styling Scribe and Explorer Advisor. Name your upcoming travel destination (whether it's the rainy forests, sunny sand dunes, or cold coastal cliffs), and I will coordinate a custom organic wardrobe packing list and share the stories behind our creations!",
          ...
          >
            ...
            <div className="p-4 border-b border-sand/10 bg-ink flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="font-medium text-linen" id="ai-chat-title">tirupati merchandise Explorer Advisor</h3>
