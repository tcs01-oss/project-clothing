...
import { addReviewToFirestore, updateReviewInFirestore, deleteReviewFromFirestore, updateProductPriceInFirestore, submitReviews, getReviewsForProduct } from "../lib/firebase";
...
export default function AdminDashboard({
  ...
  const handleSaveReview = async (e: React.FormEvent) => {
    ...
    try {
      if (editingReviewItem) {
        ...
        fetch(`/api/admin/reviews/${editingReviewItem.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${authToken}`
        ...
        }).catch(e => console.warn("API review update notice:", e));
        ...
        }).catch(e => console.warn("API review add notice:", e));
  ...
  const handleBulkImportReviews = async (e: React.FormEvent) => {
    ...
    try {
      await submitReviews(parsed, selectedProductForReviews.id);
                ...
                <button
                  onClick={() => {
                    ...
                    setProductForm({
                      ...
                      topSizes: ["6", "7", "8", "9", "10", "11", "12"] as string[],
                      bottomSizes: ["6", "7", "8", "9", "10", "11", "12"] as string[],
                    ...
                    <div className="space-y-2 text-xs">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-mono text-white">
                          {selectedOrderDetails.customerPhone || selectedOrderDetails.shippingAddress?.phone || "N/A"}
                        </span>
                      </div>
                    </div>
                  </div>
